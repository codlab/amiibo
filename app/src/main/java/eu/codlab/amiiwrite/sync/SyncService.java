...
public class SyncService extends Service {
    ...
    public boolean exists(final String uuid) {
        Amiibo amiibo = AmiiboFactory.getAmiiboCache().getAmiibo(uuid);
        return amiibo != null;
    }
    ...
    @DebugLog
    public void upload() {
        List<Amiibo> amiibos = AmiiboFactory.getAmiiboCache()
                .getAmiibosUnsynced();
    ...
    public void setUploaded(String uuid, boolean success) {
        AmiiboFactory.getAmiiboCache().setUploaded(uuid, success);
    }
